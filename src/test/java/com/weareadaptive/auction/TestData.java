...
public class TestData {
   ...
   public static final Organisation ORGANISATION3 = new Organisation(12, ORG_3, new ArrayList<>() {{
    ...
    public static final User ADMIN = new User(0, "admin", "admin", "admin", "admin", ADMIN_ORGANISATION, UserRole.ADMIN);
    public static final User USER1 = new User(1, "testuser1", "password", "john", "doe", ORGANISATION1, UserRole.USER);
    public static final User USER2 = new User(2, "testuser2", "password", "john", "smith", ORGANISATION1, UserRole.USER);
    public static final User USER3 = new User(3, "testuser3", "password", "jane", "doe", ORGANISATION2, UserRole.USER);
    public static final User USER4 = new User(4, "testuser4", "password", "naomie", "legault", ORGANISATION2, UserRole.USER);
